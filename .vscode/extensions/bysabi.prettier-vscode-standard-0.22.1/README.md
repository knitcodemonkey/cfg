...
[Visual Studio Code Market Place: Prettier - JavaScript formatter](https://marketplace.visualstudio.com/items?itemName=bysabi.prettier-vscode-standard)

Can also be installed using 

```
ext install prettier-vscode-standard
```
