...
class FileService {
    ...
    static GetFile(filePath, fileName) {
        return __awaiter(this, void 0, void 0, function* () {
            var me = this;
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                let fileExists = yield FileService.FileExists(filePath);
                if (fileExists) {
                    FileService.ReadFile(filePath).then(function (content) {
                        if (content != null) {
                ...
                fs.readdir(directory, function (err, data) {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            let isDir = yield FileService.IsDirectory(fullPath);
                            if (isDir) {
                                if (depth < fullDepth) {
                                    let filews = yield FileService.ListFiles(fullPath + "/", depth + 1, fullDepth, fileExtensions);
                                ...
                                let hasExtension = fullPath.lastIndexOf(".") > 0 ? true : false;
                                let allowedFile = false;
                                if (hasExtension) {
                                    let extension = fullPath.substr(fullPath.lastIndexOf(".") + 1, fullPath.length);
                                ...
                                if (allowedFile) {
                                    var file = yield FileService.GetFile(fullPath, data[i]);
                                    files.push(file);
                                }
                            }
                        }
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            if (fileName.indexOf("|") > -1) {
                ...
                for (var i = 0; i < paths.length - 1; i++) {
                    var element = paths[i];
                    fullPath += element + "/";
                    let x = yield FileService.CreateDirectory(fullPath);
                }
    ...
    static DeleteFile(filePath) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
                if (filePath) {
                    let stat = yield FileService.FileExists(filePath);
                    if (stat) {
