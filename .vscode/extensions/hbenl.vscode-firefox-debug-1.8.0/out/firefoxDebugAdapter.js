...
class FirefoxDebugAdapter extends debugAdapterBase_1.DebugAdapterBase {
    ...
    setBreakpoints(args) {
        ...
        const breakpoints = breakpointInfos.map(breakpointInfo => {
            const breakpoint = new vscode_debugadapter_1.Breakpoint(breakpointInfo.verified, breakpointInfo.requestedBreakpoint.line, breakpointInfo.requestedBreakpoint.column);
    ...
    setPopupAutohide(enabled) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield this.session.preferenceActor.setBoolPref(addonManager_1.popupAutohidePreferenceKey, !enabled);
        });
    }
    togglePopupAutohide() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const currentValue = yield this.session.preferenceActor.getBoolPref(addonManager_1.popupAutohidePreferenceKey);
            const newValue = !currentValue;
            yield this.session.preferenceActor.setBoolPref(addonManager_1.popupAutohidePreferenceKey, newValue);
            return !newValue;
        });
    }
    disconnect(args) {
