...
class FrameAdapter {
    ...
    getStackframe() {
        ...
        return new vscode_debugadapter_1.StackFrame(this.id, name, sourceAdapter.source, this.frame.where.line, this.frame.where.column || 1);
    }
    dispose() {
