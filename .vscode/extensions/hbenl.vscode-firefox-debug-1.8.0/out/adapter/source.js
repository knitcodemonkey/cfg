...
const info_1 = require("../firefox/sourceMaps/info");
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (this.newBreakpointProtocol) {
                ...
                const additionPromises = breakpointsToAdd.map((breakpointInfo) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    const actualLocation = info_1.findNextBreakpointPosition(breakpointInfo.requestedBreakpoint.line, breakpointInfo.requestedBreakpoint.column || 0, breakpointPositions);
