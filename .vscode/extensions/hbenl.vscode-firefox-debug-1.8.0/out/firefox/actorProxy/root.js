...
class RootActorProxy extends events_1.EventEmitter {
    constructor(sourceMaps, pathMapper, connection) {
        super();
        ...
        if (response['applicationType']) {
            ...
            tabsResponse.tabs.forEach((tab) => {
                ...
                if (this.tabs.has(tab.actor)) {
                    ...
                    actorsForTab = [
                        new tab_1.TabActorProxy(tab.actor, tab.title, tab.url, this.sourceMaps, this.pathMapper, this.connection),
            ...
            this.pendingProcessRequests.resolveOne([
                new tab_1.TabActorProxy(processResponse.form.actor, 'Browser', processResponse.form.url, this.sourceMaps, this.pathMapper, this.connection),
