...
class WebExtensionActorProxy extends events_1.EventEmitter {
    constructor(webExtensionInfo, sourceMaps, pathMapper, connection) {
        super();
    ...
    receiveResponse(response) {
        if (response['form']) {
            ...
            this.pendingConnectRequests.resolveOne([
                new tab_1.TabActorProxy(connectResponse.form.actor, this.webExtensionInfo.name, connectResponse.form.url, this.sourceMaps, this.pathMapper, this.connection),
