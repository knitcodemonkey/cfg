...
class FirefoxDebugSession {
    constructor(config, sendEvent) {
        ...
        this._newBreakpointProtocol = false;
        ...
        this.breakpointsManager = new index_2.BreakpointsManager(this.threads, this.sendEvent);
    ...
    get newBreakpointProtocol() { return this._newBreakpointProtocol; }
    start() {
        return new Promise((resolve, reject) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            let socket = yield this.connectToFirefox();
            this.firefoxDebugConnection = new index_1.DebugConnection(this.config.sourceMaps, this.pathMapper, socket);
            ...
            rootActor.onInit((initialResponse) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (this.config.reloadOnChange) {
                ...
                if (this.config.reloadOnChange.debounce > 0) {
                    reload = debounce_1.default(reload, this.config.reloadOnChange.debounce);
                }
    ...
    connectToFirefox() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (socket === undefined) {
                this.firefoxProc = yield launch_1.launchFirefox(this.config.launch);
    ...
    attachConsole(consoleActor, threadAdapter) {
        consoleActor.onConsoleAPICall((consoleEvent) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.addLocation(outputEvent, consoleEvent.filename, consoleEvent.lineNumber, consoleEvent.columnNumber);
            this.sendEvent(outputEvent);
        }));
        consoleActor.onPageErrorCall((err) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (err.category === 'content javascript') {
                ...
                yield this.addLocation(outputEvent, err.sourceName, err.lineNumber, err.columnNumber);
                this.sendEvent(outputEvent);
            }
        }));
    ...
    addLocation(outputEvent, url, line, column) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            for (let [, thread] of this.threads) {
                let originalSourceLocation = yield thread.findOriginalSourceLocation(url, line, column);
    ...
    sendCustomEvent(event, eventBody) {
        this.sendEvent(new vscode_debugadapter_1.Event(event, eventBody));
    }
}
