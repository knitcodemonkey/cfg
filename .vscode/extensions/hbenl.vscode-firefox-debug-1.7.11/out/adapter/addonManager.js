...
class AddonManager {
                ...
                if (addon.id === this.config.id) {
                    (() => tslib_1.__awaiter(this, void 0, void 0, function* () {
                        ...
                        if (addon.isWebExtension) {
                            ...
                            this.addonActor = new index_1.TabActorProxy(addon.actor, addon.name, '', sourceMaps, this.debugSession.pathMapper, this.debugSession.firefoxDebugConnection);
    ...
    unzip(srcFile, destDir) {
        return new Promise((resolve, reject) => {
            let extractor = unzipper_1.Extract({ path: destDir });
