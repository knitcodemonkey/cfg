...
(function (InternalErrorCode) {
    ...
    InternalErrorCode[InternalErrorCode["FailedToExecAppCenterLogin"] = 112] = "FailedToExecAppCenterLogin";
    InternalErrorCode[InternalErrorCode["FailedToExecAppCenterLogout"] = 113] = "FailedToExecAppCenterLogout";
    InternalErrorCode[InternalErrorCode["FailedToExecAppCenterWhoAmI"] = 114] = "FailedToExecAppCenterWhoAmI";
    InternalErrorCode[InternalErrorCode["FailedToExecAppCenterSetCurrentApp"] = 115] = "FailedToExecAppCenterSetCurrentApp";
    InternalErrorCode[InternalErrorCode["FailedToExecAppCenterGetCurrentApp"] = 116] = "FailedToExecAppCenterGetCurrentApp";
    InternalErrorCode[InternalErrorCode["FailedToExecAppCenterReleaseReact"] = 117] = "FailedToExecAppCenterReleaseReact";
    InternalErrorCode[InternalErrorCode["FailedToExecAppCenterSetCurrentDeployment"] = 118] = "FailedToExecAppCenterSetCurrentDeployment";
    InternalErrorCode[InternalErrorCode["FailedToExecAppCenterShowMenu"] = 119] = "FailedToExecAppCenterShowMenu";
    InternalErrorCode[InternalErrorCode["FailedToExecAppCenterSwitchMandatoryPropForRelease"] = 120] = "FailedToExecAppCenterSwitchMandatoryPropForRelease";
    InternalErrorCode[InternalErrorCode["FailedToExecAppCenterSetTargetBinaryVersionForRelease"] = 121] = "FailedToExecAppCenterSetTargetBinaryVersionForRelease";
