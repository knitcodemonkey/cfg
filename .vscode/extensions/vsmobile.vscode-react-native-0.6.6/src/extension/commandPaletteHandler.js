...
const appCenterCommandPalleteHandler_1 = require("./appcenter/appCenterCommandPalleteHandler");
...
class CommandPaletteHandler {
    ...
    static appCenterLogin() {
        return this.selectProject()
            .then((project) => {
            return CommandPaletteHandler.getAppCenterCommandPalleteHandler(project).run(appCenterConstants_1.AppCenterCommandType.Login);
        });
    }
    static appCenterLogout() {
        return this.selectProject()
            .then((project) => {
            return CommandPaletteHandler.getAppCenterCommandPalleteHandler(project).run(appCenterConstants_1.AppCenterCommandType.Logout);
        });
    }
    static appCenterWhoAmI() {
        return this.selectProject()
            .then((project) => {
            return CommandPaletteHandler.getAppCenterCommandPalleteHandler(project).run(appCenterConstants_1.AppCenterCommandType.Whoami);
        });
    }
    static appCenterSetCurrentApp() {
        return this.selectProject()
            .then((project) => {
            return CommandPaletteHandler.getAppCenterCommandPalleteHandler(project).run(appCenterConstants_1.AppCenterCommandType.SetCurrentApp);
        });
    }
    static appCenterGetCurrentApp() {
        return this.selectProject()
            .then((project) => {
            return CommandPaletteHandler.getAppCenterCommandPalleteHandler(project).run(appCenterConstants_1.AppCenterCommandType.GetCurrentApp);
        });
    }
    static appCenterSetCurrentDeployment() {
        return this.selectProject()
            .then((project) => {
            return CommandPaletteHandler.getAppCenterCommandPalleteHandler(project).run(appCenterConstants_1.AppCenterCommandType.SetCurrentDeployment);
        });
    }
    static appCenterCodePushReleaseReact() {
        return this.selectProject()
            .then((project) => {
            return CommandPaletteHandler.getAppCenterCommandPalleteHandler(project).run(appCenterConstants_1.AppCenterCommandType.CodePushReleaseReact);
        });
    }
    static appCenterShowMenu() {
        return this.selectProject()
            .then((project) => {
            return CommandPaletteHandler.getAppCenterCommandPalleteHandler(project).run(appCenterConstants_1.AppCenterCommandType.ShowMenu);
        });
    }
    static appCenterSwitchMandatoryPropForRelease() {
        return this.selectProject()
            .then((project) => {
            return CommandPaletteHandler.getAppCenterCommandPalleteHandler(project).run(appCenterConstants_1.AppCenterCommandType.SwitchMandatoryPropForRelease);
        });
    }
    static appCenterSetTargetBinaryVersionForRelease() {
        return this.selectProject()
            .then((project) => {
            return CommandPaletteHandler.getAppCenterCommandPalleteHandler(project).run(appCenterConstants_1.AppCenterCommandType.SetTargetBinaryVersionForRelease);
        });
    }
    ...
    static getAppCenterCommandPalleteHandler(project) {
        if (!CommandPaletteHandler.appCenterCommandPalleteHandler) {
            CommandPaletteHandler.appCenterCommandPalleteHandler = new appCenterCommandPalleteHandler_1.AppCenterCommandPalleteHandler(CommandPaletteHandler.logger);
        }
