...
const appCenterExtensionManager_1 = require("./appcenter/appCenterExtensionManager");
        ...
        if (version && isSupportedVersion(version)) {
            entryPointHandler.runFunction("debugger.setupLauncherStub", errorHelper_1.ErrorHelper.getInternalError(internalErrorCode_1.InternalErrorCode.DebuggerStubLauncherFailed), () => {
                ...
                return setupAndDispose(reactDirManager, context)
                    ...
                    let appCenterManager = new appCenterExtensionManager_1.AppCenterExtensionManager(projectRootPath);
...
function registerAppCenterCommands(context) {
    registerVSCodeCommand(context, appCenterConstants_1.ACCommandNames.Login, errorHelper_1.ErrorHelper.getInternalError(internalErrorCode_1.InternalErrorCode.FailedToExecAppCenterLogin), () => commandPaletteHandler_1.CommandPaletteHandler.appCenterLogin());
    registerVSCodeCommand(context, appCenterConstants_1.ACCommandNames.Logout, errorHelper_1.ErrorHelper.getInternalError(internalErrorCode_1.InternalErrorCode.FailedToExecAppCenterLogout), () => commandPaletteHandler_1.CommandPaletteHandler.appCenterLogout());
    registerVSCodeCommand(context, appCenterConstants_1.ACCommandNames.WhoAmI, errorHelper_1.ErrorHelper.getInternalError(internalErrorCode_1.InternalErrorCode.FailedToExecAppCenterWhoAmI), () => commandPaletteHandler_1.CommandPaletteHandler.appCenterWhoAmI());
    registerVSCodeCommand(context, appCenterConstants_1.ACCommandNames.SetCurrentApp, errorHelper_1.ErrorHelper.getInternalError(internalErrorCode_1.InternalErrorCode.FailedToExecAppCenterSetCurrentApp), () => commandPaletteHandler_1.CommandPaletteHandler.appCenterSetCurrentApp());
    registerVSCodeCommand(context, appCenterConstants_1.ACCommandNames.GetCurrentApp, errorHelper_1.ErrorHelper.getInternalError(internalErrorCode_1.InternalErrorCode.FailedToExecAppCenterGetCurrentApp), () => commandPaletteHandler_1.CommandPaletteHandler.appCenterGetCurrentApp());
    registerVSCodeCommand(context, appCenterConstants_1.ACCommandNames.SetCurrentDeployment, errorHelper_1.ErrorHelper.getInternalError(internalErrorCode_1.InternalErrorCode.FailedToExecAppCenterSetCurrentDeployment), () => commandPaletteHandler_1.CommandPaletteHandler.appCenterSetCurrentDeployment());
    registerVSCodeCommand(context, appCenterConstants_1.ACCommandNames.CodePushReleaseReact, errorHelper_1.ErrorHelper.getInternalError(internalErrorCode_1.InternalErrorCode.FailedToExecAppCenterReleaseReact), () => commandPaletteHandler_1.CommandPaletteHandler.appCenterCodePushReleaseReact());
    registerVSCodeCommand(context, appCenterConstants_1.ACCommandNames.ShowMenu, errorHelper_1.ErrorHelper.getInternalError(internalErrorCode_1.InternalErrorCode.FailedToExecAppCenterShowMenu), () => commandPaletteHandler_1.CommandPaletteHandler.appCenterShowMenu());
    registerVSCodeCommand(context, appCenterConstants_1.ACCommandNames.SwitchMandatoryPropertyForRelease, errorHelper_1.ErrorHelper.getInternalError(internalErrorCode_1.InternalErrorCode.FailedToExecAppCenterSwitchMandatoryPropForRelease), () => commandPaletteHandler_1.CommandPaletteHandler.appCenterSwitchMandatoryPropForRelease());
    registerVSCodeCommand(context, appCenterConstants_1.ACCommandNames.SetTargetBinaryVersionForRelease, errorHelper_1.ErrorHelper.getInternalError(internalErrorCode_1.InternalErrorCode.FailedToExecAppCenterSetTargetBinaryVersionForRelease), () => commandPaletteHandler_1.CommandPaletteHandler.appCenterSetTargetBinaryVersionForRelease());
}
